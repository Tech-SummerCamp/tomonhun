// https://github.com/mrdoob/three.js/issues/22996
  ...
  constructor(object: any) {
    ...
    this.connect = function () {
      ...
      if (window.DeviceOrientationEvent !== undefined && typeof (window.DeviceOrientationEvent as any).requestPermission === 'function') {
        ...
        (window.DeviceOrientationEvent as any).requestPermission().then(function (response: string) {
    ...
    this.update = function () {
      ...
      if (device) {
        ...
        if (8 * (1 - lastQuaternion.dot(scope.object.quaternion)) > EPS) {
          ...
          (scope as any).dispatchEvent(_changeEvent);
